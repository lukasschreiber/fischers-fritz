  ...
  return (
    <div className="flex flex-row justify-between gap-2 items-center">
      ...
      {props.starStyle === "small" ? (
        ...
        <div className="ml-auto flex flex-col text-xs text-neutral-400 gap-1"><Stars max={5} mean={props.review.rating}/><div>{props.review.rating} Sterne</div></div>
      )}
    </div>
  );
}
