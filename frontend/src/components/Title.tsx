export function Title(props: { text: string; style?: "h2" | "h3" | "h4" }) {
  if (props.style === undefined || props.style === "h2") {
    ...
    return (
      <h3 className="font-bold text-2xl  text-neutral-700">{props.text}</h3>
    );
  } else if (props.style === "h4") {
    return (
      <h4 className="font-bold text-xl  text-neutral-700">{props.text}</h4>
    );
  }
}
